...
@Configuration
public class WebMessageConfig implements ApplicationContextAware {  // 언어팩 위치를 지정하는 클래스
...
@Configuration
class LocaleResolve implements LocaleContextResolver {  // 언어팩을 사용자의 선택으로 바뀌게 하는 클래스
...
// 언어펙 적용
@Configuration
class MessageByLocale { // 만약 사용자가 한국으로 설정했으면 한국어로 변경시켜주는 클래스
